...
\begin{enumerate}[(a)]
  \item Ecuații parametrice, de forma:
    \[
      ...
      \end{cases}, t \in (a, b)
    \]
  \item Ecuații carteziene explicite, de forma $ y = f(x) $;
  \item Ecuație carteziană implicită, de forma $ F(x, y) = 0 $.
\end{enumerate}
...
\begin{itemize}
  \item parametric, în forma:
    \[
      ...
      \end{cases}, t \in (0, \pi);
    \]
  \item cartezian explicit, sub forma: $ y = \sqrt{1 - x^2} $;
  \item cartezian implicit, sub forma $ x^2 + y^2 = 1, y > 0 $.
\end{itemize}
