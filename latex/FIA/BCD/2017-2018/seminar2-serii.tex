...
\begin{center}
  {\large\textbf{Seminar 2 \\ Serii de numere reale}}
\end{center}
...
\vspace{1cm} 
{\color{red}
  \textbf{Soluție 1.j):} Aplicăm criteriul logaritmic:
  \begin{align*}
    \ell &= \lim_{n \to \infty} \frac{-\ln x_n}{\ln n} \\
         &= \lim_{n \to \infty} \frac{\ln \big( 1 - \frac{3 \ln n}{2n} \big)^n}{\ln n} \\
         &= \lim_{n \to \infty} \frac{1}{\ln n} \cdot \ln \Big( 1 - \frac{3 \ln n}{2n} \Big)^{-n} \\
         &= \lim_{n \to \infty} \ln \Big( 1 - \frac{3 \ln n}{2n} \Big)^{-\frac{n}{\ln n}}.
  \end{align*}
  Limita comută cu logaritmul și putem calcula separat:
  \[
    \lim_{n \to \infty} \Big( 1 - \frac{3 \ln n}{2n} \Big)^{-\frac{n}{\ln n}} = %
    \Big( 1 + \frac{-3\ln n}{2n} \Big)^{-\frac{2n}{3 \ln n} \cdot \frac{3 \ln n}{-2n} \cdot \frac{-n}{\ln n}} = e^{\frac{3}{2}}.
  \]
  Revenind, obținem $\ell = \frac{3}{2}$, deci seria este convergentă.}
