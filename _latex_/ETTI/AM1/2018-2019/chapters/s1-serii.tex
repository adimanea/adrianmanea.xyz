...
\item \textbf{Criteriul logaritmic:} Fie $ \sum_n x_n $ o serie cu termeni
  ...
  \[
    \ell = \lim_{n \to \infty} \frac{\ln \frac{1}{n}}{\ln n}.
  \]
  Atunci:
  \begin{itemize}
  \item Dacă $ \ell < 1 $, seria este divergentă;
...
În cazul seriilor care pot avea și termeni negativi, convergența se studiază
folosind o clasificare mai fină. Astfel, avem:

\begin{definition}\label{def:ac-semi} \index{serii!absolut convergente}
  \index{serii!semiconvergente}
  Fie seria $ \sum_n x_n $, cu termeni oarecare.

  Seria se numește \emph{absolut convergentă} dacă seria $ \sum_n |x_n| $ este
  convergentă și \emph{semiconvergentă} dacă seria modulelor este divergentă,
  dar seria inițială este convergentă.
\end{definition}

Să remarcăm că, deoarece, în general $ |x| \geq x, \forall x \in \RR $,
orice serie absolut convergentă este convergentă. Reciproc, este fals:
seria $ \sum_n \dfrac{(-1)^n}{n} $ vom vedea că este convergentă,
fără a fi absolut convergentă.

Evident, dacă seria inițială este divergentă (suma ei fiind $ \pm \infty $),
problema convergenței absolute nu se mai pune, deoarece seria modulelor
va fi tot divergentă, cu suma $ +\infty $.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Exerciții}

1. Studiați natura următoarelor serii, definite de șirul termenilor generali $ (x_n) $, cu:
\begin{multicols}{2}
  \begin{enumerate}[(1)]
  \item $ x_n = \Big( \dfrac{3n}{3n + 1} \Big)^n $ (D, necesar);
  \item $ x_n = \dfrac{1}{n!} $ (C, comparație);
  \item $ x_n = \dfrac{1}{n \sqrt{n+1}} $ (C, comparație);
  \item $ x_n = \arcsin \dfrac{n+1}{2n + 3} $ (D, necesar);
  \item $ x_n = \Big( 1 - \dfrac{1}{n} \Big)^n $ (D, necesar);
  ...
  \item $ x_n = \Big( \dfrac{n + 1}{3n + 1} \Big)^n $ (C, radical);
  \item $ x_n = \Big( 1 - \dfrac{1}{n} \Big)^{n^2} $ (C, radical);
  \item $ x_n = \big( \sqrt{n^2 + a\cdot n + 1} - n \big)^n, a \geq 0 $ (discuție, radical);
  \item $ x_n = \dfrac{\sqrt{7n}}{n^2 + 3n + 5} $ (C, comparație);
  ...
  \item $ x_n = \dfrac{1}{7^n + 3^n} $ (C, comparație termen cu termen);
  \item $ x_n = \dfrac{2 + \sin n}{n^2} $ (C, comparație termen cu termen);
  \item $ x_n = \dfrac{\cos^2 n}{3^n} $ (C, comparație termen cu termen);
  \item $ x_n = \dfrac{\sin^2 n}{n^2 + 1} $ (C, comparație termen cu termen);
  \item $ x_n = \dfrac{\sqrt{n}}{\ln(n+1)} $ (D, necesar);
  \item $ x_n = \Big[ 3 + \Big( 1 + \dfrac{1}{n} \Big)^n \Big] $ (D, necesar);
...
2. Studiați convergența absolută a seriilor cu termenul general dat de:
\begin{enumerate}[(a)]
\item $ x_n = \dfrac{1}{n+i} $ (raționalizează, distribuie numărătorul, aplică %
  un criteriu de comparație $ \Rightarrow $ D);
\item $ x_n = \dfrac{1}{(n + i)\sqrt{n}} $ (AC [comparație la limită] $ \Rightarrow $ C);
\item $ x_n = \dfrac{n(2 + i)^n}{3^n} $ (AC [raport] $ \Rightarrow $ C).
\end{enumerate}
