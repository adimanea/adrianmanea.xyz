...
\begin{enumerate}[(1)]
    ...
    \item $ x_n = \dfrac{\sqrt[3]{n^3 + n^2} - n}{n^2} $; \hfill(parțial ACS)
    \item $ x_n = (-1)^n \dfrac{n}{n^2 - 1} $; \hfill(parțial ACS)
    \item $ x_n = (-1)^n (\sqrt{n^2 + 1} - n) $; \hfill(parțial ACS)
