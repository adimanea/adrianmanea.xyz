...
\item $ \ds\int_\Gamma \dfrac{\exp(z^2)}{z^2 - 6z} dz $, unde
  $ \Gamma: |z - 2| = r, r \in \{1, 3, 5\} $;
...
\begin{align*}
  \Rez(f, z_1) &= \frac{1}{(2-1)!} \lim_{z \to 1} \Big[ (z - 1)^2 \frac{z^2 + 1}{(z - 1)^2(z + 2)} \Big]^\prime \\
               &= \frac{1}{1!} \lim_{z \to 1} \frac{z^2 + 4z - 1}{(z + 2)^2} \\
               &= \frac{4}{9} \\
...
Rezultă:
\[
  I = \int_{|z| = 3} \frac{z^2 + 1}{(z - 1)^2(z + 2)} dz = 2 \pi i.
\]
