...
\[
  \begin{cases}
    ...
    \dfrac{\partial u}{\partial t}(x, 0) &= \dfrac{n\pi}{l}ab_n\sin\dfrac{n\pi}{l}x = \psi(x)
  \end{cases}.
\]
...
\begin{eqnarray} \label{eq:fourier}
  a_n &= \dfrac{2}{l} \int_0^l \varphi(x) \sin \dfrac{n\pi}{l} xdx \\
  b_n &= \dfrac{2}{n\pi a} \int_0^l \psi(x) \sin \dfrac{n \pi}{l} xdx.
\end{eqnarray}
