...
\[
  \vec{V} = xy^2 \vec{i} + x^2y \vec{y} + z(x^2 + y^2) \vec{k}.
\]
...
\[
  u(x, y, z) = \varphi\Big(x^2 - y^2, \dffrac{xy}{z} \Big),
\]
...
\]
care trece prin curba dată de intersecția cilindrului $ x^2 + y^2 = 4 $ cu
planul $ y = 0 $.
...
Se obține $ 2c_1 - c_2 = 4 $, deci $ 2(x^2 - y^2) - (x^2 - z^2) = 4 $, care
...
\[
  z_x = -\dfrac{u_x}{u_z}, \quad \dfrac{z_y} = -\dfrac{u_y}{u_z}.
\]
...
\indent\indent Rezolvați ecuațiile cvasiliniare:
\begin{enumerate}[(a)]
