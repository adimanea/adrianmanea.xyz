...
\begin{definition}\label{def:subspatii}\index{spații vectoriale!subspații}
    ...
    \emph{subspațiu vectorial} al lui $ V $, notat $ W \leq_K V $ dacă $ W $
...
%\begin{theorem}\label{thm:subspatiu}
    ...
    %Atunci $ W \leq_K V $ dacă și numai dacă, pentru orice $ w_1, w_2 \in W $
...
\begin{enumerate}
    ...
    \item $ \RR_n[X] \leq_\RR \RR[X] $, pentru orice număr natural $ n $.
...
\begin{remark}\label{rk:inters-subsp}
    Dacă $ V_1, V_2 \leq_K V $, este imposibil ca $ V_1 \cap V_2 = \emptyset $. (Justificați!)
\end{remark}
...
\begin{enumerate}[(a)]
    \item $ V_1 = \{ (x, y) \in \RR^2 \mid 3x - y = 0 \} \leq_\RR \RR^2 $;
    \item $ V_2 = \{ (x, y, z) \in \RR^3 \mid 3x - y = 0 \} \leq_\RR \RR^3 $;
    \item $ V_3 = \{ (x, y, z) \in \RR^3 \mid x = 0 \} \leq_\RR \RR^3 $;
    \item $ V_4 = \{ p \in \RR_2[X] \mid p(1) = 0 \} \leq_\RR \RR_2[X] $;
    \item $ V_5 = \{ p \in \RR_2[X] \mid p'(1) = 0 \} \leq_\RR \RR_2[X] $;
    \item $ V_6 = \{ (x, y, z) \in \RR^3 \mid 3x - y + z = 0, 2x + y = 0 \} \leq_\RR \RR^3 $;
    \item $ V_7 = \{ A \in M_2(\RR) \mid A = A^t \} $;
    \item $ V_8 = \{ A \in M_2(\RR) \mid \dr{tr}A = 0 \} $.
\end{enumerate}
...
\]
\begin{enumerate}[(a)]
    \item Să se arate că $ W \leq_\RR M_{2, 3}(\RR) $;
