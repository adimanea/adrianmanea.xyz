\chapter{Polinomul Taylor și extreme libere}
...
\begin{align*}
  T(x, y) &= f(x_0, y_0) + \frac{1}{1!} \Big[ (x - x_0) \frac{\partial f}{\partial x}_A + %
...
\begin{align*}
  T_1(x, y) &= f(x_0, y_0) + \frac{1}{1!} \Big[ %
    (x - x_0) \frac{\partial f}{\partial x}_A + %
    (y - y_0) \frac{\partial f}{\partial y}_A \Big] \\
  T_2(x, y) &= T_1(x, y) + \frac{1}{2!} \Big[ %
    (x - x_0)^2 \frac{\partial^2 f}{\partial x^2}_A + %
    2(x - x_0)(y - y_0) \frac{\partial^2 f}{\partial x \partial y}_A + %
    (y - y_0)^2 \frac{\partial^2 f}{\partial y^2}_A \Big].
\end{align*}
...
\item Determinăm \emph{valorile proprii} $ \lambda_{1,2} $ ale matricei hessiene,
  ...
  \item Dacă $ \lambda_1 \cdot \lambda_2 = 0 $, problema necesită un studiu
    separat, acesta fiind un caz mai dificil și pe care îl omitem la acest curs.
  \end{itemize}
