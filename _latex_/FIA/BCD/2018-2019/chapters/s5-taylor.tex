...
11. Să se precizeze convergența seriilor de funcții:
\begin{enumerate}[(a)]
\item $ \sum \dfrac{n^2}{\sqrt{n!}} (x^n + x^{-n}), \dfrac{1}{2} \leq x \leq 2 $;
\item $ \sum \dfrac{nx}{1 + n^5 x^2}, x \in \RR $;
\item $ \sum \arctan \dfrac{2x}{x^2 + n^4}, x \in \RR $;
\item $ \sum \dfrac{1}{2^n} \cos(3^n x), x \in \RR $;
\item $ \sum \dfrac{(x + n)^2}{n^4}, x \in [1, 2] $;
