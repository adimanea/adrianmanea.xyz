...
8. \begin{enumerate}[(a)]
    \item Fie funcția $ f(x) = \sqrt[3]{x + 1} $.
        ...
        \end{enumerate}
    \item Fie funcția $ f(x) = \sin x + \cos x, x \in [0, \pi] $. 
        \begin{enumerate}[(i)]
            \item Scrieți polinoamele Taylor $ T_1 $ și $ T_2 $ în jurul
                originii.
            \item Calculați $ \sqrt{2} $ folosind $ T_2 $.
            \item Estimați eroarea calculului de mai sus.
        \end{enumerate}
    \item Fie funcția $ f(x) = \ln(1 + 3x)^2 $.
        \begin{enumerate}[(i)]
            ...
            \item Estimați eroarea calculului de mai sus.
        \end{enumerate}
    \item Fie funcția $ f(x) = \arctan \sqrt{x + 1}, x \geq 0 $.
        \begin{enumerate}[(i)]
            \item Scrieți polinoamele Taylor $ T_1 $ și $ T_2 $ în jurul originii.
            \item Calculați $ \arctan 0,1 $ folosind $ T_2 $.
            \item Estimați eroarea calculului de mai sus.
        \end{enumerate}
\end{enumerate}
