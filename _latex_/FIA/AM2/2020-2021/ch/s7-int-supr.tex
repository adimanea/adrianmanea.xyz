...
\indent\indent 1. Calculați $ \ds\int_\Sigma x^2 d\sigma $, unde $ \Sigma $ este
suprafața sferei $ x^2 + y^2 + z^2 = 1 $.

\vspace{0.3cm}

2. Calculați aria suprafeței paraboloidului $ z = x^2 + y^2 $, aflat
sub planul de ecuație $ z = 2 $.

\vspace{0.3cm}

3. Calculați aria suprafeței paraboloidului $ z = 4 - x^2 - y^2 $,
care se află deasupra planului $ XOY $.

\vspace{0.3cm}

4. Calculați aria suprafeței paraboloidului $ z = x^2 + y^2 $,
aflată între planele $ XOY $ și $ z = 4 $.

\vspace{0.3cm}

5. Calculați aria emisferei superioare a sferei centrate în origine
și cu raza $ R = 2 $.

\vspace{0.3cm}

6. Fie cîmpul vectorial $ \vec{V} = (-x, z, y^2) $. Aflați fluxul
cîmpului $ \vec{V} $ prin suprafața $ \Sigma $, delimitată
de partea paraboloidului $ z = x^2 + y^2 $, situată sub planul $ z = 3 $.

\vspace{0.3cm}

7. Calculați $ \ds\int_\Sigma xy dy \wedge dz + yz dz \wedge dx + (x + y) dx \wedge dy $,
unde $ \Sigma $ este suprafața definită prin:
\[
  \Sigma = \{ (x, y, z) \in \RR^3 \mid x^2 + y^2 = 4, x > 0, y > 0, 0 < z < 4 \}.
\]

\vspace{0.3cm}

8. Determinați fluxul cîmpului vectorial $ \vec{V} = (0, y, -z) $
prin suprafața delimitată de sfera $ x^2 + y^2 + z^2 = 4 $, situată
în primul octant.

\vspace{0.3cm}

9. Determinați fluxul cîmpului vectorial $ \vec{V} = (x, 0, z) $ prin
suprafața delimitată de paraboloidul $ y = x^2 + z^2 $, cu $ 0 \leq y \leq 1 $.

\vspace{0.3cm}

10. Calculați $ \ds\int_\Sigma x dy \wedge dz + xy dz \wedge dx + (x - y) dx \wedge dy $,
unde $ \Sigma $ este definită prin:
\[
  \Sigma = \{ (x, y, z) \in \RR^3 \mid x^2 + y^2 + z^2 = 4, y \geq 0 \}.
\]