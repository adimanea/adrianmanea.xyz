...
\begin{enumerate}[(a)]
    ...
    \item $ D = \{(x, y) \in \RR^2 \mid x^2 + y^2 \leq x, y \geq 0 \} $,
        iar $ f(x, y) = xy $;
    \item $ D = \{ (x, y) \in \RR^2 \mid y + x^2 - 2 = 0, y = 1 \} $,
        iar $ f(x, y) = xy + e^x $;
    \item $ D = \{ (x, y) \in \RR^2 \mid y + 3x - 1 = 0, 1 \geq y \leq 7, -2 \leq x \leq 0 \} $,
        iar $ f(x, y) = y^2 + x^2 - x $;
    \item $ D = \{ (x, y) \in \RR^2 \mid y - x + 3 = 0, 0 \leq x \leq 3 \} $,
        iar $ f(x, y) = x^2 + 2 $;
    \item $ D = \{ (x, y) \in \RR^2 \mid y = x^2 + 3x + 2, y \leq 0 \} $,
        iar $ f(x, y) = xy $;
    \item $ D = \{ (x, y) \in \RR^2 \mid y = -x^2 + 6x - 8, x \geq 3, y \geq 0 \} $,
        iar $ f(x, y) = -x^2 + 6x $.
\end{enumerate}
...
4. Calculați ariile domeniilor de la începutul lecției.
