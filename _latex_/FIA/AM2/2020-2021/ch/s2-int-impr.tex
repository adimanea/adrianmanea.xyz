...
\item $\ds\int_1^\infty \frac{dx}{x \sqrt{x} - 1} $ \hfill(C $x \to \infty$,
  D $x = 1 \Rightarrow$ D);
...
\begin{multicols}{2}
  ...
  \item $ \ds\int_0^\infty \dfrac{dx}{\sqrt[3]{x^2}(1 + x^3)} $;
  \item $ \ds\int_{-3}^\infty e^{-2x^2 - 12x + 5} dx $;
  \item $ \ds\int_0^1 \sqrt[5]{\ln \dfrac{3}{x^2}} dx $;
  \item $ \ds\int_0^1 \dfrac{dx}{\sqrt[n]{1 - x^n}} $;
  \item $ \ds\int_0^{\frac{\pi}{2}} \sin^3 x \cdot \cos^5 x dx $;
