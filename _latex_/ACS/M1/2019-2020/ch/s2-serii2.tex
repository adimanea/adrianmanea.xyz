...
general $ x_n $ dat de:
\begin{enumerate}[(a)]
    \item $ x_n = \dfrac{1}{\ln n} $; \hfill(D, integral)
    \item $ x_n = \dfrac{1}{n \ln n} $; \hfill(C, integral/condensare)
...
atunci seria inițială $ \sum \alpha y_n $ este convergentă.
...
scoate $ n $. Se obține $ n = 7 $ pentru primul exercițiu și $ n = 4 $ pentru
al doilea.

Concluzia este că, pentru a obține valoarea sumei seriei cu o precizie de 3, respectiv
2 zecimale, este suficient să considerăm primi 6, respectiv primii 3 termeni ai seriei. 
