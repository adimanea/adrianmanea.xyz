\chapter{Integrale de suprafață. Formule integrale 2}

\section{Integrale de suprafață de speța întîi}
\index{integrala!de suprafață!speța întîi}
...
\index{integrala!de suprafață!speța a doua}
...
1. Calculați vectorii tangenți și versorul normalei la suprafețele
...
\frac{\partial}{\partial y}, \frac{\partial}{\partial z} \Big) $ și
cîmpul $ \vec{V} = (P, Q, R) $.
