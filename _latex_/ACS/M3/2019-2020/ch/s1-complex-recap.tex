...
\begin{corollary}\label{cor:not-olo}
  Dacă una dintre funcțiile $ P $ sau $ Q $ nu este armonică, atunci funcție
...
\indent\indent 1. Verificația dacă funcția de mai jos este olomorfă:
\[
...
6. Scrieți sub formă trigonometrică și polară numerele complexe:
\begin{enumerate}[(a)]
\item $ z = 3 - i $;
\item $ z = 3 + i $;
\item $ z = i $;
