...
$ r \to \infty $ a integralei. Dar, conform lemei Jordan, integrala pe semicercul $ \Gamma_r $
...
\begin{align*}
    I_r &= \ds\int_\Gamma f(z) dz = \ds\int_{-r}^r f(x) dx + \ds\int_\gamma f(z) dz \\
        &= 2 \pi i \ds\sum_{k=1}^n \mathrm{Rez}(f, z_k) + \pi i \ds\sum_{k=1}^n \mathrm{Rez}(f, z'_k),
\end{align*}

pentru $ z_k $ pol cu $ \dr{Im}z_k > 0 $ și $ z'_k $ pol simplu, cu $ \dr{Im}z_k = 0 $ (\textbf{teorema semireziduurilor}).
...
Și, deoarece $ \ds\lim_{r \to \infty} |z f(z)| = 0 $, rezultă, cu lema Jordan, că $ \ds\lim_{r \to \infty} \int_\gamma f(z) dz = 0 $,
deci integrala căutată este egală cu $ \ds\lim_{r \to \infty} I_r $.
